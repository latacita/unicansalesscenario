...
%                           Thesis's details                          %
%=====================================================================%
\newcommand{\myname}{Manuel Vega Saldarriaga}  % name of author
\newcommand{\myboss}{Pablo Sánchez Barreiro} % name of supervisor
\newcommand{\thesistitle}{Desarrollo Orientado a Características de un Sistema de Gestión de Ventas bajo la Plataforma .NET}

\newcommand{\englishtitle}{Feature-Oriented Softwere Development \\ of a Sales Management Systems in .NET}
												  % work title
...
% Capítulo 2: Resumen del Estado del Arte% \input{background/background.tex}
